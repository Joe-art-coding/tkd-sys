        ...
        try:
            ...
            if user.check_password(password):
                ...
                if selected_student_id:
                    current_student = Student.objects.get(id=selected_student_id)
                else:
                    current_student = children_list[0] if children_list else None
                ...
                if current_student:
                    ...
                    # Get all records first (no slice)
                    ...
                    # Then slice for display (last 30 records)
                ...
                if current_student and current_student.club:
                    ...
                    # Get schedule for this student's school
                    ...
                    # Get contact info for this club
