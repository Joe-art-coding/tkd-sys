...
class ParentAdmin(admin.ModelAdmin):
    list_display = ['student', 'user', 'relationship', 'phone']
    list_filter = ['relationship']
    search_fields = ['student__name', 'student__ic_number', 'user__username', 'phone']
    ...
    def get_queryset(self, request):
        ...
        current_club = getattr(request, 'club', None)
        if current_club:
            return qs.filter(student__club=current_club)
        return qs
